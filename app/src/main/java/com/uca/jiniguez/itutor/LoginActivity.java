...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        UserData.noFileFound = getFilesDir().getAbsolutePath()+"/photo2.png";
        ...
        Button mRegister = (Button) findViewById(R.id.email_sign_new_button);
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            try {
                ...
                String url = UserData.url+"/user/login";
            ...
            for (String credential : DUMMY_CREDENTIALS) {
                ...
                if (pieces[0].equals(mEmail)) {
                    // Account exists, return true if the mPassword matches.
